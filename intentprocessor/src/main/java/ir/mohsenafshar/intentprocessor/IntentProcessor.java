package ir.mohsenafshar.intentprocessor;
...
import ir.mohsenafshar.javaintentannotation.IntentAnnotation;

@SupportedAnnotationTypes({
        "ir.mohsenafshar.javaintentannotation.IntentAnnotation"
})
public class IntentProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> set, RoundEnvironment roundEnvironment) {
        ...
        try {
            for (Element element : roundEnvironment.getElementsAnnotatedWith(IntentAnnotation.class)) {
